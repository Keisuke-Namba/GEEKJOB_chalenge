 ...
 * @author southkaito
 */
@WebServlet(name = "JDBChtml8", urlPatterns = {"/JDBChtml8"})
public class JDBChtml8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int ID = Integer.parseInt(request.getParameter("ID"));
            ...
            db_st.setString(1,"清水綾");
            db_st.setString(2,"080-3645-7263");
            db_st.setInt(3, 21);
            db_st.setDate(4, Date.valueOf("1996-1-4"));
            db_st.setInt(5, ID);
            db_st.execute();
